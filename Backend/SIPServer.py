...
from SIP.factory import InterUserCommunicationServerFactory

import requests
from SIP.messages import *
import re

SIP_SERVER_IP = "192.168.43.64"#"192.168.43.64"
SIP_SERVER_PORT = '5001'
# API connection used for user auth
API_PREFIX = 'http://'
API_IP = '192.168.43.64'#'localhost'#'127.0.0.1'#
API_PORT = '5000'
...
class SIPProtocol(WebSocketServerProtocol):
    ...
    def onMessage(self, payload, isBinary):
        ...
        if method == "REGISTER":
            ...
            self.pass_to_peer(peer_id, payload, sip_msg)
        elif method == "CANCEL" or method == "x": #dev
